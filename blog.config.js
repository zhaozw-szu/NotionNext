...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Joy', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的程序员', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.zzwblog.top', // 网站地址
  ...
  PREVIEW_TAG_COUNT: 32, // 首页最多展示的标签数量，0为不限制
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'Love & Peace & Share | Welcome ！', // 站点描述，被notion中的页面描述覆盖
